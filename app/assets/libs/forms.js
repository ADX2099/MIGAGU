...
if(isAndroid === true){
	textFieldDefaults.width= Ti.Platform.displayCaps.platformWidth * 0.85;
	textFieldDefaults.height= Ti.Platform.displayCaps.platformHeight * 0.087;
...
var addField = function(field, fieldRefs) {
	...
	if (type === exports.TYPE_TEXT ||
		...
		if(isAndroid){fieldObject.backgroundImage = "/images/login/textfield.png";}
...
// 			
		...
		if(isAndroid){
			button.width= Ti.Platform.displayCaps.platformWidth * 0.85;
			button.height= Ti.Platform.displayCaps.platformHeight * 0.087;
